/* Background mandalas, henna/mehndi style.
   ...
   viewport over ~90 seconds, in orange that lightens toward yellow as it
   reaches out toward the text.
...
(function () {
  ...
  /* Orange at the corner, warming into a light yellow toward the rim -- the
     rim is what reaches furthest into the page, so this is what lightens as
     the ink nears the text. Kept light so the line-work sits behind the text
     without competing. */
  var STOPS = [
    [0.00, 235, 118, 42],
    [0.28, 241, 144, 60],
