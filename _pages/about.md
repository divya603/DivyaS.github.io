...
Currently, I am the lab manager and junior Laboratory Associate jointly under the [Computation and Decision-Making Lab](https://codec-lab.github.io/)  (PI: Dr. Mark Ho) and [AI Thought Partner Lab](https://ilia10000.github.io/) (PI: Dr. Ilia Sucholutsky) where I am exploring decision-making in humans and AI systems.
...
In my Master's thesis under Professor Todd Gureckis at the [Computation and Cognition Lab](https://gureckislab.org/), I am studying how humans integrate social testimony with direct experiential learning, particularly when these two sources of information are presented at different points in time or come into conflict.
...
Previously at Anna University, my bachelo's thesis was advised by [Joannes Sam Mertens](https://scholar.google.com/citations?user=k6c4nK4AAAAJ&hl=en) from The University of Catania where I designed deep learning pipelines using CNN and LSTM autoencoders to capture temporal driving patterns and behavioral signatures from raw sensor data
